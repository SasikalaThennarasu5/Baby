...
import twinbaby from "../assets/images/boy1.png";
import babyrocker from "../assets/images/boy2.png";
import lavern from "../assets/images/boy3.png";
import rockroll from "../assets/images/boy4.png";
import kinger from "../assets/images/boy5.png";
import dravos from "../assets/images/boy6.png";
...
const BoysFashion = () => {
  return (
    <div className="p-6 md:p-10 font-poppins">
      <p className="text-sm text-gray-600 mb-4">Home &gt; Products &gt; Boys Fashion</p>

      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold">Boys Dresses</h2>
