...
import twinbaby from "../assets/images/pamper1.png";
import babyrocker from "../assets/images/pamper2.png";
import lavern from "../assets/images/pamper3.png";
import rockroll from "../assets/images/pamper4.png";
import kinger from "../assets/images/pamper5.png";
import dravos from "../assets/images/pamper6.png";
...
const Pampers = () => {
  return (
    <div className="p-6 md:p-10 font-poppins">
      <p className="text-sm text-gray-600 mb-4">Home &gt; Products &gt; Diaper</p>

      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold">Diapers</h2>
