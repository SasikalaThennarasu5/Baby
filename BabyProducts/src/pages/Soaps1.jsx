...
import twinbaby from "../assets/images/soap1.png";
import babyrocker from "../assets/images/soap2.png";
import lavern from "../assets/images/soap3.png";
import rockroll from "../assets/images/soap4.png";
import kinger from "../assets/images/soap5.png";
import dravos from "../assets/images/soap6.png";
...
const Soaps = () => {
  return (
    <div className="p-6 md:p-10 font-poppins">
      <p className="text-sm text-gray-600 mb-4">Home &gt; Products &gt; Baby Soaps</p>

      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold">Baby Soaps</h2>
        ...
        {products.map((item) => (
          <div key={item.id} className="border rounded-xl shadow-sm relative">
            ...
            <div className="p-4 bg-[#B0E4F4] rounded-b-xl relative">
              ...
              <Link
  to={`/product/${item.id}`}
  className="absolute top-4 right-4 bg-accent text-white px-4 py-1 rounded-full text-sm font-semibold hover:bg-[#0096c7] transition"
>
  Buy
</Link>
            </div>
